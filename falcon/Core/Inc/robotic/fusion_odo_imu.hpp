...
void fusion_odo_imu_fuse(float ax_imu_g,
                         ...
                         float yaw_imu_deg, int delta_motor_left_ticks, int delta_motor_right_ticks, float dt_s,
                         float theta_deg, float *delta_x_m, float *delta_y_m, float *delta_theta_deg,
